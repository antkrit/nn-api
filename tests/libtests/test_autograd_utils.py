...
def test_check_node_name_format():
    var = ag.Variable(1, name='test')
    assert utils.check_node_name_format(var)

    var.name = 'wrong'
    assert not utils.check_node_name_format(var)
...
def test_convert_to_node(session):
    ...
    assert utils.check_node_name_format(test_case_var)
    ...
    assert utils.check_node_name_format(test_case_pl)
    ...
    assert utils.check_node_name_format(test_case_cnst)
